...
const Header = () => {
    return (
        <div className="container mx-xs-auto text-white pt-xs-28 pt-sm-20 pt-md-16 pt-lg-12 pt-xl-10 pb-xs-20 pb-sm-12 pb-md-10 pb-xl-8">
            <div className="xs-flex-column md-flex-column lg-flex-row h-xs-inherit">
                <div className="xs-flex-column justify-content-center w-md-100 w-lg-70 w-xxl-60">
                    <h4 className="font-size-xs-1_2rem font-weight-xs-500">Hello there👋 Daniel here😊</h4>
                    <h1 className="font-size-xs-2_2rem font-size-sm-3rem font-size-md-3_6rem font-size-lg-4rem font-weight-xs-600 line-height-90 mt-xs-1_8 mt-sm-4 mb-xs-1_4 mb-sm-2">I'm a (digital) product designer, product manager and frontend developer</h1>
                ...
                <div className="xs-flex-column justify-content-center w-md-100 w-lg-30 w-xxl-40 bg-dark-800 rounded-04"></div>
            </div>
        </div>
    )
}
