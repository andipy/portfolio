...
const Gantt = () => {
    ...
    return (
        <div className="container mx-xs-auto pb-xs-20 pb-sm-12 pb-md-10 pb-xl-8">
            <div className="flex-row-xs justify-content-between align-items-end">
                ...
                <img className="w-xs-15 w-sm-10 w-md-5 display-none-lg" src={LongArrow} alt="" />                
            </div>
            
            <div className="relative carousel mt-xs-1 mt-sm-2 pt-xs-8 pt-sm-6 pt-md-4 pt-lg-2 overflow-x-xs-auto overflow-y-xs-hidden overflow-lg-visible w-xs-carousel w-lg-full">
